<%@ Page Language="C#" MasterPageFile="~/Users/Admin/MasterPage.master" AutoEventWireup="True" Inherits="Admin_Online_users" Title="Users Online" Codebehind="Online_users.aspx.cs" %>
...
<asp:Content ID="Content7" runat="server" contentplaceholderid="cphContentBody">
    ...
    <asp:GridView ID="UsersGridView" runat="server" AutoGenerateColumns="False" onrowcreated="UserAccounts_RowCreated" onrowdeleting="UserAccounts_RowDeleting" DataKeyNames="userName" EmptyDataText="Either end of records or No visitors in the last 15 minutes.">
        <Columns>
            <asp:TemplateField>
    ...
    <asp:Label ID="lblDeleteSuccess" runat="server" Text="User(s) were sucessfully deleted!" Visible="false"></asp:Label>
