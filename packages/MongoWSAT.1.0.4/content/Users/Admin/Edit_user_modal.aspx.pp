<%@ Page Language="C#" AutoEventWireup="True" Inherits="Admin_Edit_user_modal" Title="Edit User Details" Codebehind="Edit_user_modal.aspx.cs" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <cc1:TabContainer ID="tcntUserInfo" runat="server" ActiveTabIndex="1" Width="100%" Font-Size="10px">
