<%@ Page Language="C#" MasterPageFile="~/Users/Admin/MasterPage.master" AutoEventWireup="True" Inherits="Admin_Active_users" Title="Unapproved Accounts" Codebehind="Active_users.aspx.cs" %>
...
<asp:Content ID="Content7" runat="server" contentplaceholderid="cphContentBody">
    ...
    <%-- active user filter dropdown list --%>
    <asp:DropDownList ID="active" runat="server" AutoPostBack="true" ToolTip="Select between inactive/active accounts">
        <asp:ListItem>Inactive Accounts</asp:ListItem>
    ...
    <%-- success label for delete action  --%>
